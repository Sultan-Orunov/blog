                ...
                <div class="menu-bg-wrap">
                    <div class="site-navigation">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <a href="{{ route('post.index') }}" class="logo m-0 float-start text-decoration-none">{{ config('app.name', 'Blogy') }}<span class="text-primary">.</span></a>
                            </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="post-entry-footer">
                            <ul>
                                <li>
                                    <a href="">
                                        <img src="{{ url('assets/images/img_1_sq.jpg') }}" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                ...
                                <li>
                                    <a href="">
                                        <img src="{{ url('assets/images/img_2_sq.jpg') }}" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">March 15, 2018 </span>
                                ...
                                <li>
                                    <a href="">
                                        <img src="{{ url('assets/images/img_3_sq.jpg') }}" alt="Image placeholder" class="me-4 rounded">
                                        <div class="text">
                                            <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">March 15, 2018 </span>
